...
void Parser::reallocateStack()
{
    ...
    sym_stack = reinterpret_cast<Value*> (std::realloc(sym_stack, stack_size * sizeof(Value)));
    state_stack = reinterpret_cast<int*> (std::realloc(state_stack, stack_size * sizeof(int)));
    location_stack = reinterpret_cast<AST::SourceLocation*> (std::realloc(location_stack, stack_size * sizeof(AST::SourceLocation)));
}
