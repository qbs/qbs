...
public:
    constexpr explicit Version(
        int majorVersion = 0, int minorVersion = 0, int patchLevel = 0, int buildNr = 0)
    ...
    static QBS_EXPORT Version
    fromString(const QString &versionString, bool buildNumberAllowed = false);
    QString QBS_EXPORT toString(
...
template<>
struct hash<qbs::Version>
{
    std::size_t operator()(const qbs::Version &v) const noexcept
    {
        std::size_t seed = 0;
        qbs::Internal::hashCombineHelper(seed, v.majorVersion());
        qbs::Internal::hashCombineHelper(seed, v.minorVersion());
        qbs::Internal::hashCombineHelper(seed, v.patchLevel());
        qbs::Internal::hashCombineHelper(seed, v.buildNumber());
        return seed;
    }
};
