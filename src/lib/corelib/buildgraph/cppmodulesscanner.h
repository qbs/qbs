...
#ifndef QBS_CXXMODULESSCANNER_H
#define QBS_CXXMODULESSCANNER_H
...
{
public:
    explicit CppModulesScanner(ScriptEngine *engine, JSValue targetScriptValue);
    ~CppModulesScanner();
...
private:
    ...
    const JSValue m_targetScriptValue;
};

} // namespace qbs::Internal

#endif // QBS_CXXMODULESSCANNER_H
